...
public class Memorama extends JFrame {
	...
	public Memorama() {
		...
		panel.setBackground(Color.decode("#184033"));
		...
		panel_1.setBackground(Color.decode("#184033"));
		...
		panel_2.setBackground(Color.decode("#184033"));
		...
		panel_3.setBackground(Color.decode("#184033"));
		contentPane.add(panel_3, BorderLayout.SOUTH);
		
		JButton btnNewButton_15 = new JButton("Jugar de nuevo");
